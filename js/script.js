...
if (document.documentElement.clientWidth > 768) {
	myPageSlider = new Swiper('.page-slider', {
	...
	myPageSlider = new Swiper('.page-slider', {
		...
		//* сколько написать, столько и будет отображаться слайдов в окне браузера, значение 'auto' - выставляет кол-во слайдов автоматически (хрен бы знал, что это значит)
		slidesPerView: 6,
		//slidesPerView: 'auto',
		...
		// watchOverflow: true,
		//*@ Свободный режим
		//*@ В нём изображение не доезжает до следующего слайда, а останавливается где оставили
		freeMode: true,
	});
